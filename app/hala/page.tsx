    ...
    <div style={{ fontFamily: "Arial, sans-serif", lineHeight: 1.6, color: "#0f172a" }}>
      ...
      <section style={{ padding: "90px 20px", textAlign: "center", background: "linear-gradient(135deg, #0f172a, #1e3a8a)", color: "white" }}>
        ...
        <p style={{ marginTop: "14px", fontSize: "16px", opacity: 0.85 }}>
          Websites from £299 • Lead capture included • Free consultation
        </p>
...
>
  Website Design
          ...
          <a href="/self-assessment-calculator" style={{ ...buttonStyle, background: "#16a34a", color: "white" }}>
          ...
          <a href="/company-formation" style={{ ...buttonStyle, background: "#9333ea", color: "white" }}>
      ...
      <p style={{ textAlign: "center", marginTop: "30px", fontSize: "14px", color: "#64748b" }}>
        Website design UK • SEO services UK • Small business websites • Lead generation • Business automation tools UK
      </p>
      ...
      <section style={{ padding: "70px 20px", background: "#f8fafc" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(230px, 1fr))", gap: "20px" }}>
            {[
              ["Website Design", "Modern websites for small businesses, trades, startups and professional firms."],
              ...
              ["Business Tools", "Custom calculators, quote tools, tax tools, VAT tools and automation workflows."],
            ].map(([title, text]) => (
...
>
  Website Design for Small Businesses
      ...
      <section style={{ padding: "70px 20px", background: "#ffffff", textAlign: "center" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "20px", maxWidth: "1000px", margin: "0 auto" }}>
          ...
          <div style={{ padding: "20px", border: "1px solid #e2e8f0", borderRadius: "12px" }}>
            ...
            <span style={{ color: "#64748b" }}>Built for service-based businesses</span>
          </div>
      ...
      <section style={{ padding: "70px 20px", textAlign: "center", background: "#eef6ff" }}>
        ...
        <p style={{ marginTop: "10px", fontWeight: "bold" }}>Limited time: First 5 clients only</p>
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "20px", marginTop: "35px" }}>
            {[
              ...
              ["Business Tools Package", "From £49/month", "Quote calculators, tax tools, VAT tools and lead capture widgets."],
      ...
      <section style={{ padding: "70px 20px", textAlign: "center", background: "#f8fafc" }}>
        ...
        <p style={{ maxWidth: "720px", margin: "10px auto 25px", color: "#475569" }}>
          We are building practical tools for tax, VAT, pricing, websites and client lead generation.
        </p>
      ...
      <section style={{ padding: "70px 20px", background: "white", textAlign: "center" }}>
        ...
        <div style={{ maxWidth: "850px", margin: "30px auto", display: "grid", gap: "14px", color: "#334155" }}>
          ...
          <p>✅ Custom-built, fast and scalable website setup</p>
      ...
      <section style={{ padding: "70px 20px", background: "#0f172a", color: "white", textAlign: "center" }}>
        ...
        <p style={{ marginTop: "10px", opacity: 0.85 }}>Tell us what you need and we’ll get back to you.</p>
        ...
        <form action="https://formspree.io/f/xbdwlgdv" method="POST" style={{ maxWidth: "520px", margin: "30px auto", display: "grid", gap: "12px" }}>
          ...
          <select name="service" required style={{ padding: "14px", borderRadius: "8px", border: "none" }}>
            ...
            <option>Quote Calculator / Business Tool</option>
            <option>Company Formation</option>
            <option>Not sure yet</option>
          </select>

          <textarea name="message" placeholder="Tell us briefly what you need" rows={4} required style={{ padding: "14px", borderRadius: "8px", border: "none" }} />
      ...
      <section style={{ padding: "50px 20px", textAlign: "center" }}>
        <h2>Free Resources and Tools</h2>
        ...
        <div style={{ marginTop: "20px", display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "12px" }}>
          ...
          <a href="/vat-registration">VAT Registration Guide</a>
          <a href="/vat-property">VAT on Property</a>
          <a href="/vat-sic">VAT SIC Tool</a>
        </div>
      </section>
