...
export default function EditClientPage() {
  ...
  const loadClient = async () => {
    ...
    if (error || !data) {
      setMessage(error?.message || "Client not found or access denied.");
      setLoading(false);
      return;
    }
    ...
    setForm({
      ...
      hmrc_income_source_type: data.hmrc_income_source_type || "",
    ...
    <main style={styles.page}>
      <div style={styles.container}>
        <div style={styles.header}>
          ...
          <button onClick={saveClient} disabled={saving} style={styles.saveButton}>
        ...
        <div style={styles.card}>
          <div style={styles.grid}>
            ...
            <Input label="NINO" name="nino" value={form.nino} onChange={handleChange} />
            <Input label="UTR" name="utr" value={form.utr} onChange={handleChange} />
            <Input label="Business name" name="business_name" value={form.business_name} onChange={handleChange} />
            <Input label="Client reference" name="client_reference" value={form.client_reference} onChange={handleChange} />

            <div style={styles.field}>
              <label style={styles.label}>Income source</label>
              <select
            ...
            <Input label="MTD Income Tax ID" name="mtd_income_tax_id" value={form.mtd_income_tax_id} onChange={handleChange} />
            <Input label="VAT number" name="vat_registration_number" value={form.vat_registration_number} onChange={handleChange} />
